    ...
    return (
        <>
            ...
            <article className={styles.policy}>
                <CardPolicy
                    title = 'Como meus dados serão usados ?'
                    paragraph=" A UNOBIKE valoriza a privacidade e a segurança dos dados de seus usuários. Todas as informações pessoais 
                                coletadas são utilizadas exclusivamente para a adequada prestação dos serviços oferecidos, incluindo, mas não 
                                se limitando a gestão de operações, controle de acesso, cobrança, comunicação com o usuário, suporte técnico e 
                                garantia da segurança dos sistemas e da integridade das bicicletas."
                ...
                />
                <CardPolicy
                    title = 'Como eu posso solicitar alguma alteração nos meus dados ?'
